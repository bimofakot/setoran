...
const AuthShell = ({ children, mode }: { children: React.ReactNode; mode: 'login' | 'signup' }) => (
  <div className="min-h-dvh flex items-center justify-center p-4 relative overflow-hidden">
    ...
    <div className="relative w-full max-w-[420px] animate-fade-up">
      ...
      {/* Card */}
      <div className="border rounded-2xl shadow-2xl shadow-black/30 backdrop-blur-xl overflow-hidden"
  ...
  return (
    <AuthShell mode="login">
      <div className="flex items-center gap-2 mb-6">
        ...
        <h2 className="text-lg font-bold" style={{ color: 'var(--text-primary)' }}>Masuk</h2>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex flex-col gap-1.5">
          <label className="text-xs font-semibold uppercase tracking-wider" style={{ color: 'var(--text-muted)' }}>Kata Sandi</label>
      ...
      <div className="relative my-5">
        ...
        <div className="relative flex justify-center text-xs"><span className="px-3 text-xs" style={{ background: 'var(--bg-surface)', color: 'var(--text-muted)' }}>atau</span></div>
      </div>
  ...
  return (
    <AuthShell mode="signup">
      <div className="flex items-center gap-2 mb-6">
        ...
        <h2 className="text-lg font-bold" style={{ color: 'var(--text-primary)' }}>Buat Akun</h2>
      </div>
